...
class TestAuthService:
    ...
    def test_authenticate_user(self, db_session, test_user) -> None:
    ...
    def test_login_for_access_token(self, db_session, test_user) -> None:
        db_session.add(test_user)
        db_session.commit()
...
def test_create_and_verify_token(db_session) -> None:
    user_id = uuid4()
