...
def test_get_user_by_id(db_session, test_user) -> None:
...
def test_change_password(db_session, test_user) -> None:
...
def test_change_password_invalid_current(db_session, test_user) -> None:
    db_session.add(test_user)
    db_session.commit()
...
def test_change_password_mismatch(db_session, test_user) -> None:
    db_session.add(test_user)
    db_session.commit()
